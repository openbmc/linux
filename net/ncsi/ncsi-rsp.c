...
static void ncsi_find_package_and_channel(struct ncsi_dev_priv *ndp,
					  unsigned char id,
...
static struct ncsi_rsp_handler {
	...
	unsigned char	nrh_aen_type;
	int		(*nrh_handler)(struct ncsi_req *nr);
} ncsi_rsp_handlers[] = {
	{ NCSI_PKT_RSP_CIS,   0, ncsi_rsp_handler_cis     },
	{ NCSI_PKT_RSP_SP,    0, ncsi_rsp_handler_sp      },
	{ NCSI_PKT_RSP_DP,    0, ncsi_rsp_handler_dp      },
	{ NCSI_PKT_RSP_EC,    0, ncsi_rsp_handler_ec      },
	{ NCSI_PKT_RSP_DC,    0, ncsi_rsp_handler_dc      },
	{ NCSI_PKT_RSP_RC,    0, ncsi_rsp_handler_rc      },
	{ NCSI_PKT_RSP_ECNT,  0, ncsi_rsp_handler_ecnt    },
	{ NCSI_PKT_RSP_DCNT,  0, ncsi_rsp_handler_dcnt    },
	{ NCSI_PKT_RSP_AE,    0, ncsi_rsp_handler_ae      },
	{ NCSI_PKT_RSP_SL,    0, ncsi_rsp_handler_sl      },
	{ NCSI_PKT_RSP_GLS,   0, ncsi_rsp_handler_gls     },
	{ NCSI_PKT_RSP_SVF,   0, ncsi_rsp_handler_svf     },
	{ NCSI_PKT_RSP_EV,    0, ncsi_rsp_handler_ev      },
	{ NCSI_PKT_RSP_DV,    0, ncsi_rsp_handler_dv      },
	{ NCSI_PKT_RSP_SMA,   0, ncsi_rsp_handler_sma     },
	{ NCSI_PKT_RSP_EBF,   0, ncsi_rsp_handler_ebf     },
	{ NCSI_PKT_RSP_DBF,   0, ncsi_rsp_handler_dbf     },
	{ NCSI_PKT_RSP_EGMF,  0, ncsi_rsp_handler_egmf    },
	{ NCSI_PKT_RSP_DGMF,  0, ncsi_rsp_handler_dgmf    },
	{ NCSI_PKT_RSP_SNFC,  0, ncsi_rsp_handler_snfc    },
	{ NCSI_PKT_RSP_GVI,   0, ncsi_rsp_handler_gvi     },
	{ NCSI_PKT_RSP_GC,    0, ncsi_rsp_handler_gc      },
	{ NCSI_PKT_RSP_GP,    0, ncsi_rsp_handler_gp      },
	{ NCSI_PKT_RSP_GCPS,  0, ncsi_rsp_handler_gcps    },
	{ NCSI_PKT_RSP_GNS,   0, ncsi_rsp_handler_gns     },
	{ NCSI_PKT_RSP_GNPTS, 0, ncsi_rsp_handler_gnpts   },
	{ NCSI_PKT_RSP_OEM,   0, ncsi_rsp_handler_default },
	{ 0,                  0, NULL                     }
};
		 ...
		 struct packet_type *pt, struct net_device *orig_dev)
{
	...
	for (i = 0; i < sizeof(ncsi_rsp_handlers) / sizeof(ncsi_rsp_handlers[0]); i++) {
		if (ncsi_rsp_handlers[i].nrh_type == hdr->type) {
