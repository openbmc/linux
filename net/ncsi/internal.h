...
enum {
	...
	ncsi_dev_state_init_deselect	= 0x0201,
	ncsi_dev_state_init_package,
	ncsi_dev_state_init_channel,
	ncsi_dev_state_init_sp,
	ncsi_dev_state_init_cis,
	ncsi_dev_state_init_gvi,
	ncsi_dev_state_init_gc,
	ncsi_dev_state_init_dp,
	ncsi_dev_state_init_active,
	ncsi_dev_state_init_sma,
	ncsi_dev_state_init_ebf,
	ncsi_dev_state_init_ecnt,
	ncsi_dev_state_init_ec,
	ncsi_dev_state_init_gls,
	ncsi_dev_state_init_done,
	ncsi_dev_state_stop_select	= 0x0301,
...
/* Command */
int ncsi_xmit_cmd(struct ncsi_cmd_arg *arg);
